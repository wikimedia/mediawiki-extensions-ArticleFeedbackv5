...
class ArticleFeedbackv5Flagging {
	...
	private function unhide( $notes, $toggle ) {
		...
		if ( $this->feedback->flag + $this->feedback->autoflag <= $this->feedback->unflag ) {
	...
	private function flag( $notes, $toggle ) {
		...
		$this->results['abuse_count'] = $this->feedback->flag + $this->feedback->autoflag - $this->feedback->unflag;
	...
	private function clear_flags( $notes, $toggle ) {
		$this->feedback->unflag = $this->feedback->flag + $this->feedback->autoflag;
