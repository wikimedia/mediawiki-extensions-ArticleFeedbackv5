...
class ArticleFeedbackv5Flagging {
	...
	private function oversight( $notes, $toggle ) {
		...
		if ( !$this->feedback->isHidden() ) {
			...
			ArticleFeedbackv5Log::logActivity( 'autohide', $this->feedback->aft_page, $this->feedback->aft_id, $notes, null, array( 'source' => $this->source ) );
	...
	private function unoversight( $notes, $toggle ) {
		...
		if ( $this->feedback->aft_hide && $this->feedback->aft_autohide ) {
			...
			ArticleFeedbackv5Log::logActivity( 'unhide', $this->feedback->aft_page, $this->feedback->aft_id, $notes, null, array( 'source' => $this->source ) );
		}
	...
	private function clear_flags( $notes, $toggle ) {
		...
		ArticleFeedbackv5Log::logActivity( 'clear-flags', $this->feedback->aft_page, $this->feedback->aft_id, $notes, null, array( 'source' => $this->source ) );
