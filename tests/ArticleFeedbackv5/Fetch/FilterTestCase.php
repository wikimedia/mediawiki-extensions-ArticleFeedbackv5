...
/**
 * ArticleFeedbackv5_Fetch_FilterTestCase
 *
 * Testing ArticleFeedbackv5Fetch
 */
class ArticleFeedbackv5_Fetch_FilterTestCase extends ArticleFeedbackv5TestCase
{

	/**
	 * testSetFilterWithHiddenFilters
	 *
	 ...
	 */
	public function testSetFilterWithHiddenFilters() {
		...
		// Test setting all hidden filters. They should all return true.
		foreach ( ArticleFeedbackv5Fetch::$hiddenFilters as $hiddenFilter ) {

			$this->assertTrue( $articleFeedbackv5Fetch->setFilter( $hiddenFilter ) );
		}
	}

	/**
	 * testSetFilterWithDeletedFilters
	 *
	 * @covers ArticleFeedbackv5Fetch::__construct
	 * @covers ArticleFeedbackv5Fetch::getFeedbackId
	 * @covers ArticleFeedbackv5Fetch::getFilter
	 ...
	 * @covers ArticleFeedbackv5Fetch::setFilter
	 */
	public function testSetFilterWithDeletedFilters() {
		...
		// Test setting all deleted filters. They should all return true.
		foreach ( ArticleFeedbackv5Fetch::$deletedFilters as $deletedFilter ) {

			$this->assertTrue( $articleFeedbackv5Fetch->setFilter( $deletedFilter ) );
		}
	}

	/**
	 * testSetFilterWithAnInvalidFilter
	 *
	 * @covers ArticleFeedbackv5Fetch::__construct
	 * @covers ArticleFeedbackv5Fetch::getFeedbackId
	 * @covers ArticleFeedbackv5Fetch::getFilter
	 ...
	 * @covers ArticleFeedbackv5Fetch::setFilter
	 */
	public function testSetFilterWithAnInvalidFilter() {
		...
		$invalidFilter = 'This filter is invalid.';
		$this->assertFalse( $articleFeedbackv5Fetch->setFilter( $invalidFilter ) );
	}
}
