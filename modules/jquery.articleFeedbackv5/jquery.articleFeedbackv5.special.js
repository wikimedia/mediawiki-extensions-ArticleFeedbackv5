...
// {{{ articleFeedbackv5special definition
	...
	$.articleFeedbackv5special.setup = function() {
		...
		$.articleFeedbackv5special.adjustSelectWidth();
	...
	/**
	 * Utility method: Adjusts the select width so we can see all of the text,
	 * and the arrow ends up neatly on the left
	 */
	$.articleFeedbackv5special.adjustSelectWidth = function() {
		var selText = $('#articleFeedbackv5-filter-select option:selected').text();
		$('#articleFeedbackv5-filter-select option:selected').html( '<span>' + selText + '</span>' );
		var selWidth = $('#articleFeedbackv5-filter-select option:selected span:first').width();
		if ( selWidth > 0 ) {
			$('#articleFeedbackv5-filter-select').css( 'width', selWidth + 30 + 'px' );
		}
		$('#articleFeedbackv5-filter-select option:selected').text( selText );
	}
