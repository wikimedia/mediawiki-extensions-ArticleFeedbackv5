			...
			'success': function( data ) {
				...
				if ( data['query-continue'] && data['query-continue']['articlefeedbackv5-view-activity'] ) {
					$( location ).find( '.articleFeedbackv5-activity-more' )
						.data( 'id', data['query-continue']['articlefeedbackv5-view-activity'].aacontinue )
						.click( function( e ) {
							e.preventDefault();
		...
		'activity': {
			...
			'click': function( e ) {
				if ( $.articleFeedbackv5special.toggleTipsy( e ) ) {
					$.articleFeedbackv5special.loadActivityLog( $( e.target ).closest( '.articleFeedbackv5-feedback' ).data( 'id' ), 0, '#articleFeedbackv5-activity-log' );
				}
			}
		},
		...
		'activity2': {
			'click': function( e ) {
				if ( $( e.target ).data( 'started' ) == true ) {
					...
					$.articleFeedbackv5special.loadActivityLog( $( '#articleFeedbackv5-show-feedback .articleFeedbackv5-feedback' ).data( 'id' ), 0, '#articleFeedbackv5-permalink-activity-log' );
