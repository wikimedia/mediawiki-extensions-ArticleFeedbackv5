<?php
/**
 * This class provides some functionality to easily get
 * feedback's activity.
 * Because this data is less often requested & because
 * we're dealing with the default MW logging table (which
 * we can't "just change"), this is a completely
 * different approach than ArticleFeedbackv5Model:
