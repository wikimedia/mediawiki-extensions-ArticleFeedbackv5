...
//'bundle-message' => 'notification-feedback-new-bundle',
//'bundle-params' => array( 'agent', 'title', 'aft_permalink', 'link-from-page', 'link-from-page-other-display', 'link-from-page-other-count' ), // @todo: what??
