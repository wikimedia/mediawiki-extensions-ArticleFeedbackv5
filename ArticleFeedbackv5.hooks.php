...
//		self::trackEvent( 'edit_attempt', $editpage->getArticle()->getTitle(), $editpage->getArticle()->getRevIdFetched()); // EditPage::getTitle() doesn't exist in 1.18wmf1
	...
	public static function onBeforeCreateEchoEvent( &$notifications, &$notificationCategories, &$icons ) {
		...
		$notifications['feedback-watch'] = array(
			...
			'title-params' => array( 'agent', 'titlelink', 'aft-permalink', 'aft-moderation-flag' ),
			'bundle-message' => 'articlefeedbackv5-notification-feedback-watch-bundle',
			'bundle-params' => array( 'agent', 'titlelink', 'aft-moderation-flag', 'aft-titlelink', 'aft-other-display', 'aft-other-count' ),
			'flyout-message' => 'articlefeedbackv5-notification-feedback-watch-flyout',
			'flyout-params' => array( 'agent', 'titlelink', 'aft-permalink', 'aft-moderation-flag' ),
			'payload' => array( 'aft-comment' ),
			'email-subject-message' => 'articlefeedbackv5-notification-feedback-watch-email-subject',
			'email-subject-params' => array( 'agent', 'titlelink', 'aft-permalink', 'aft-moderation-flag' ),
			'email-body-message' => 'articlefeedbackv5-notification-feedback-watch-email-body',
			'email-body-params' => array( 'agent', 'titlelink', 'aft-permalink', 'aft-moderation-flag', 'aft-comment', 'email-footer' ),
			'email-body-batch-message' => 'articlefeedbackv5-notification-feedback-watch-email-batch-body',
			'email-body-batch-params' => array( 'agent', 'titlelink', 'aft-permalink', 'aft-moderation-flag' ),
			'email-body-batch-bundle-message' => 'articlefeedbackv5-notification-feedback-watch-email-batch-bundle-body',
			'email-body-batch-bundle-params' => array( 'agent', 'titlelink', 'aft-moderation-flag', 'aft-titlelink', 'aft-other-display', 'aft-other-count' ),
			'icon' => 'feedback-watch',
		);
		...
		$notifications['feedback-moderated'] = array(
			...
			'bundle-params' => array( 'agent', 'titlelink', 'aft-permalink', 'agent-other-display', 'agent-other-count' ),
			...
			'email-subject-params' => array( 'agent', 'titlelink', 'aft-permalink', 'aft-moderation-flag' ),
			'email-body-message' => 'articlefeedbackv5-notification-feedback-moderated-email-body',
			'email-body-params' => array( 'agent', 'titlelink', 'aft-permalink', 'aft-moderation-flag', 'aft-comment', 'email-footer' ),
			...
			'email-body-batch-bundle-params' => array( 'agent', 'titlelink', 'aft-permalink', 'aft-comment', 'agent-other-display', 'agent-other-count' ),
