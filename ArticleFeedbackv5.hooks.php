...
//		self::trackEvent( 'edit_attempt', $editpage->getArticle()->getTitle(), $editpage->getArticle()->getRevIdFetched()); // EditPage::getTitle() doesn't exist in 1.18wmf1
	...
	public static function onBeforeCreateEchoEvent( &$notifications, &$notificationCategories, &$icons ) {
		...
		$notifications['feedback-watch'] = array(
			...
			'email-body-batch-params' => array( 'agent', 'title', 'aft-page-link', 'aft-moderation-flag' ),
			'email-body-batch-bundle-message' => 'articlefeedbackv5-notification-feedback-watch-email-batch-bundle-body',
			'email-body-batch-bundle-params' => array( 'agent', 'title', 'aft-page-link', 'aft-moderation-flag', 'aft-other-display', 'aft-other-count' ),
			'icon' => 'feedback-watch',
		);
		...
		$notifications['feedback-moderated'] = array(
			...
			'email-body-batch-params' => array( 'agent', 'title', 'aft-permalink-link', 'aft-moderation-flag' ),
			'email-body-batch-bundle-message' => 'articlefeedbackv5-notification-feedback-moderated-email-batch-bundle-body',
			'email-body-batch-bundle-params' => array( 'agent', 'title', 'aft-permalink-link', 'aft-comment', 'agent-other-display', 'agent-other-count' ),
