...
class ArticleFeedbackv5Model extends DataModel {
	...
	public static $lists = array(
		...
		'*' => array(
			'permissions' => 'noone',
			'conditions' => array(),
			'sort' => array( 'text' => '(string) $this->comment' ) // @todo: remove this sort, don't need it
		),
		...
		'visible-relevant' => array(
			...
			'sort' => array( 'relevance' => '(int) $this->relevance_score', 'age' => '(string) $this->timestamp', 'helpful' => '$this->helpful - $this->unhelpful' )
		),
