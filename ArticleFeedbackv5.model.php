...
class ArticleFeedbackv5Model extends DataModel {
	...
	public
		...
		$hide = 0,
		$unhide = 0,
		$autohide = 0, // includes undo-unhelpful
		$flag = 0,
	...
	public static function getList( $name, $shard = null, $offset = 0, $sort = 'ASC' ) {
		...
		if ( $wgUser->isAllowed( self::$lists[$name]['permissions'] ) ) {
	...
	public function isHidden() {
		return $this->hide + $this->autohide > $this->unhide;
	}
	...
	public function isOversighted() {
		return $this->oversight > $this->unoversight;
	}
	...
	public function isFeatured() {
		return $this->feature > $this->unfeature;
	}

	// @todo: build more helpers, for all actions, like the 4 above
}
