CREATE TABLE IF NOT EXISTS /*_*/aft_feedback (
  ...
  aft_user_text varbinary(255) NOT NULL DEFAULT '',
  aft_user_token varbinary(32) NOT NULL DEFAULT '',
  aft_form varchar(1) NOT NULL DEFAULT '',
  aft_cta varchar(1) NOT NULL DEFAULT '',
  aft_link varchar(1) NOT NULL DEFAULT '',
  aft_rating tinyint(1) NOT NULL,
  aft_comment varbinary(255) NOT NULL DEFAULT '',
  aft_timestamp binary(14) NOT NULL DEFAULT '',
