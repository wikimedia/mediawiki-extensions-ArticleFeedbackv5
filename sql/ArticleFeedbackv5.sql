...
CREATE INDEX /*i*/helpful ON /*_*/aft_feedback (aft_percentage_helpful, aft_id, aft_has_comment, aft_oversight, aft_archive, aft_hide);
...
CREATE INDEX /*i*/helpful_page ON /*_*/aft_feedback (aft_page, aft_percentage_helpful);
